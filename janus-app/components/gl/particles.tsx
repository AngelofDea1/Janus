...
export function Particles({
  ...
  useFrame((state, delta) => {
    ...
    if (isDark) {
      dofPointsMaterial.uniforms.uColor.value.set(1.0, 1.0, 1.0);
    } else {
      // Pure black particles for light mode — high contrast, matching dark mode's twin
      dofPointsMaterial.uniforms.uColor.value.set(0.0, 0.0, 0.0);
    }
